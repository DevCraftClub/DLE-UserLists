...
final class DashboardPage extends AbstractPage {
	...
	public function handle(): array {
		...
		return [
			...
			'data' => [
				'page_title' => (string) ($meta['name'] ?? __('Пользовательские списки')),
				'dashboard'  => [
					'app'              => [
						'name'        => (string) ($meta['name'] ?? __('Пользовательские списки')),
